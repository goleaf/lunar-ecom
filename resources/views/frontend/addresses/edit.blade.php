...
@section('title', __('frontend.addresses.edit_title'))

@section('content')
<div class="px-4 py-6 max-w-2xl mx-auto">
    <h1 class="text-3xl font-bold mb-6">{{ __('frontend.addresses.edit_title') }}</h1>

    <form action="{{ route('frontend.addresses.update', $address) }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
        @method('PUT')
