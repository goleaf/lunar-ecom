...
return new class extends Migration
{
    ...
    {
        Schema::create($this->prefix.'category_channels', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['channel_id', 'is_visible']);
            $table->index(['channel_id', 'is_in_navigation']);
        });
    }
    ...
    {
        Schema::dropIfExists($this->prefix.'category_channels');
    }
};
