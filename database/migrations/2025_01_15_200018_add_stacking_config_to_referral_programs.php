...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('referral_programs', function (Blueprint $table) {
            $table->string('default_stacking_mode')->default('exclusive')->after('attribution_ttl_days');
            $table->decimal('max_total_discount_percent', 5, 2)->nullable()->after('default_stacking_mode');
