...
/**
 * VariantAttributeValue model for storing variant-level attribute values.
 * 
 * Variants can have their own attribute values separate from product-level attributes.
 * Useful for variant-specific properties like color swatches, size-specific descriptions, etc.
 */
class VariantAttributeValue extends Model
{
    ...
    {
        return config('lunar.database.table_prefix') . 'variant_attribute_values';
    }
