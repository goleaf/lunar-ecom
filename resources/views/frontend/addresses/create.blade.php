        ...
        <div class="space-y-6">
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="company_name" id="company_name" value="{{ old('company_name') }}" class="border rounded px-3 py-2 w-full">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="first_name" id="first_name" value="{{ old('first_name') }}" required class="border rounded px-3 py-2 w-full @error('first_name') border-red-500 @enderror">
                    @error('first_name')
                ...
                <div>
                    ...
                    <input type="text" name="last_name" id="last_name" value="{{ old('last_name') }}" required class="border rounded px-3 py-2 w-full @error('last_name') border-red-500 @enderror">
                    @error('last_name')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div>
                ...
                <input type="text" name="line_one" id="line_one" value="{{ old('line_one') }}" required class="border rounded px-3 py-2 w-full @error('line_one') border-red-500 @enderror">
                @error('line_one')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" name="line_two" id="line_two" value="{{ old('line_two') }}" class="border rounded px-3 py-2 w-full">
            </div>

            <div>
                <label for="line_three" class="block text-sm font-medium text-gray-700 mb-1">Address Line 3 (Optional)</label>
                <input type="text" name="line_three" id="line_three" value="{{ old('line_three') }}" class="border rounded px-3 py-2 w-full">
            </div>

            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label for="city" class="block text-sm font-medium text-gray-700 mb-1">City *</label>
                    <input type="text" name="city" id="city" value="{{ old('city') }}" required class="border rounded px-3 py-2 w-full @error('city') border-red-500 @enderror">
                    @error('city')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="text" name="state" id="state" value="{{ old('state') }}" class="border rounded px-3 py-2 w-full">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="postcode" id="postcode" value="{{ old('postcode') }}" class="border rounded px-3 py-2 w-full">
                </div>
                <div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="email" name="contact_email" id="contact_email" value="{{ old('contact_email') }}" class="border rounded px-3 py-2 w-full @error('contact_email') border-red-500 @enderror">
                    @error('contact_email')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="text" name="contact_phone" id="contact_phone" value="{{ old('contact_phone') }}" class="border rounded px-3 py-2 w-full">
                </div>
            </div>

            <div>
                <label for="delivery_instructions" class="block text-sm font-medium text-gray-700 mb-1">Delivery Instructions (Optional)</label>
                <textarea name="delivery_instructions" id="delivery_instructions" rows="3" class="border rounded px-3 py-2 w-full">{{ old('delivery_instructions') }}</textarea>
            </div>
