...
class BundleController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'sku' => 'nullable|string|unique:bundles,sku',
            ...
            'prices.*.customer_group_id' => 'nullable|exists:customer_groups,id',
    ...
    public function update(Request $request, Bundle $bundle): JsonResponse
    {
        $validated = $request->validate([
            ...
            'description' => 'nullable|string',
            'slug' => 'sometimes|string|unique:bundles,slug,' . $bundle->id,
            'sku' => 'nullable|string|unique:bundles,sku,' . $bundle->id,
