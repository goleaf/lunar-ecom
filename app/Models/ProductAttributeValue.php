...
/**
 * ProductAttributeValue model for storing flexible attribute values.
 * 
 * Stores attribute values separately from attribute_data JSON for:
 * - Better filtering performance
 * - Easier querying
 * - Support for complex attribute types
 */
class ProductAttributeValue extends Model
{
    ...
    {
        return config('lunar.database.table_prefix') . 'product_attribute_values';
    }
